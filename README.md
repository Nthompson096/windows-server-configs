...
If you're getting errors on this list not being completed; add in more ram, I started out with at least 16 GB for the SCCM server but you could try 8 GB; typical workstations could be 64GB in ram for GNS3 (or higher if you're fancy)
